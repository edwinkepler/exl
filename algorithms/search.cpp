...
namespace exl
{
    ...
    template int binary_search(std::vector<long long>& _list, long long _item);
    ...
    template long long find_smallest(std::vector<long long>& _item);
    ...
    template long long find_largest(std::vector<long long>& _item);
}
